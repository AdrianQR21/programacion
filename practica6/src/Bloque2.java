...
public class Bloque2 {
    ...
    public void RepositoriosGremios() {
        ...
        miembros1.add("Raphinha");
        miembros1.add("Lamine Yamal");
        miembros1.add("Lewandowski");

        ArrayList<String> miembros2 =new ArrayList<>();
        miembros2.add("Adrian");
        miembros2.add("Lucia");
        miembros2.add("Mbappé");
    ...
    public void BuscadorTaidores(){
        ...
        ArrayList<String> miembros1 =new ArrayList<>();
        miembros1.add("Fernando");
        miembros1.add("Luisa");
        miembros1.add("Patricia");

        ArrayList<String> miembros2 =new ArrayList<>();
        miembros2.add("Cristiano");
        miembros2.add("Messi");
        miembros2.add("Judas");
