...
public class GestionMundo {
    ...
    public void cargarTodo() {
        ...
        items = itemR.readList("practica07/Ficheros/items.json", Item.class);
        ...
        personajes = personajeR.readList("practica07/Ficheros/personajes.json", Personaje.class);
            ...
            try {
                ...
                for (String id : personaje.getEquipoIds()) {
                    ...
                    if(!idItems.containsKey(id)) {
                        ...
                        guardar.writeList("practica07/Ficheros/personajes.json", personajes);
